...
public class GreatwoodSapFallParticleProvider implements ParticleProvider<SimpleParticleType>
{
    public SpriteSet set;

    public GreatwoodSapFallParticleProvider(SpriteSet set)
    {
        this.set = set;
    }
    ...
    {
        GreatwoodSapParticle particle = new GreatwoodSapParticle.HoneyFallAndLandParticleGreatwood(pLevel, pX, pY, pZ, ParticleInit.GREATWOOD_SAP_LANDING.get());

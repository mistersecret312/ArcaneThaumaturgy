        ...
        if(player != null)
        {
            ...
            if (mainHand || offHand)
            {
                ...
                if(stack != null)
                {
                    ...
                    guiGraphics.blit(TEXTURE, x - 271 - 5, y - 95 - 13, 92, 0, 8, 48);
                    ...
                    guiGraphics.blit(TEXTURE, x - 271 , y - 95, 84, 0, 8, 48);
                    ...
                    guiGraphics.blit(TEXTURE, x - 271 + 3, y - 95 + 15, 60, 0, 8, 48);
                    ...
                    guiGraphics.blit(TEXTURE, x - 271 - 5 , y - 95 + 34, 68, 0, 8, 48);
                    ...
                    guiGraphics.blit(TEXTURE, x - 271 - 5, y - 95 + 34, 52, 0, 8, 48);
                    guiGraphics.blit(TEXTURE, x - 275 - 5, y - 105 + 34, 36, 0, 16, 68);
                    pose.popPose();
                    ...
                    guiGraphics.blit(TEXTURE, x - 271 - 5, y - 95 + 45, 76, 0, 8, 48);

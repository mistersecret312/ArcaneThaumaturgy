...
public class BlockInit
{
    ...
    public static final RegistryObject<AmethystBlock> BUDDING_CRYSTALLIZED_IGNIS = registerBlock("budding_crystallized_ignis", () -> new BuddingAmethystBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).randomTicks().strength(1.5F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops().pushReaction(PushReaction.DESTROY)));
    ...
    public static final RegistryObject<AmethystBlock> BUDDING_CRYSTALLIZED_AQUA = registerBlock("budding_crystallized_aqua", () -> new BuddingAmethystBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLUE).randomTicks().strength(1.5F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops().pushReaction(PushReaction.DESTROY)));
    ...
    public static final RegistryObject<AmethystBlock> BUDDING_CRYSTALLIZED_TERRA = registerBlock("budding_crystallized_terra", () -> new BuddingAmethystBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).randomTicks().strength(1.5F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops().pushReaction(PushReaction.DESTROY)));
    ...
    public static final RegistryObject<AmethystBlock> BUDDING_CRYSTALLIZED_ORDO = registerBlock("budding_crystallized_ordo", () -> new BuddingAmethystBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).randomTicks().strength(1.5F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops().pushReaction(PushReaction.DESTROY)));
    ...
    public static final RegistryObject<AmethystBlock> BUDDING_CRYSTALLIZED_PERDITIO = registerBlock("budding_crystallized_perditio", () -> new BuddingAmethystBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).randomTicks().strength(1.5F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops().pushReaction(PushReaction.DESTROY)));

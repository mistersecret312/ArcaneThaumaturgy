...
public class AspectInit
{
    ...
    public static final RegistryObject<Aspect> TUMORE = ASPECTS.register("tumore", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/tumore.png")).withCompound(AspectInit.PRAECANTATIO.get(), AspectInit.PERDITIO.get()));

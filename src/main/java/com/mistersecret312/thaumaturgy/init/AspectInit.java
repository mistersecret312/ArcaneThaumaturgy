...
public class AspectInit
{
    ...
    public static final RegistryObject<Aspect> FAMES = ASPECTS.register("fames", () -> new Aspect(List.of(0x80, 0x20, 0x20), ResourceLocation.parse("thaumaturgy:textures/aspect/fames.png")).withCompound(AspectInit.BESTIA.get(), AspectInit.VACUOS.get()));

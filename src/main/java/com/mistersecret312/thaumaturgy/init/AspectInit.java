...
public class AspectInit
{
    ...
    public static final RegistryObject<Aspect> VENEUM = ASPECTS.register("veneum", () -> new Aspect(List.of(0xB8, 0xE5, 0xDF), ResourceLocation.parse("thaumaturgy:textures/aspect/veneum.png")).withCompound(AspectInit.AQUA.get(), AspectInit.PERDITIO.get()));
    ...
    public static final RegistryObject<Aspect> VITIUM = ASPECTS.register("vitium", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/vitium.png")).withCompound(AspectInit.PRAECANTATIO.get(), AspectInit.PERDITIO.get()));
    ...
    public static final RegistryObject<Aspect> SPIRITUS = ASPECTS.register("spiritus", () -> new Aspect(List.of(0x73, 0xE5, 0xE5), ResourceLocation.parse("thaumaturgy:textures/aspect/spiritus.png")).withCompound(AspectInit.SENSUS.get(), AspectInit.MOTUS.get()));
    public static final RegistryObject<Aspect> COGNITO = ASPECTS.register("cognito", () -> new Aspect(List.of(0xE5, 0xC9, 0xAC), ResourceLocation.parse("thaumaturgy:textures/aspect/cognito.png")).withCompound(AspectInit.SPIRITUS.get(), AspectInit.ORDO.get()));
    public static final RegistryObject<Aspect> HUMANUS = ASPECTS.register("humanus", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/humanus.png")).withCompound(AspectInit.BESTIA.get(), AspectInit.COGNITO.get()));
    public static final RegistryObject<Aspect> MORTUUS = ASPECTS.register("mortuus", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/mortuus.png")).withCompound(AspectInit.VICTUS.get(), AspectInit.PERDITIO.get()));
    ...
    public static final RegistryObject<Aspect> TENEBRAE = ASPECTS.register("tenebrae", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/tenebrae.png")).withCompound(AspectInit.LUX.get(), AspectInit.VACUOS.get()));
    public static final RegistryObject<Aspect> FAMES = ASPECTS.register("fames", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/fames.png")).withCompound(AspectInit.BESTIA.get(), AspectInit.VACUOS.get()));
    public static final RegistryObject<Aspect> FACERE = ASPECTS.register("facere", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/facere.png")).withCompound(AspectInit.HUMANUS.get(), AspectInit.POTENTIA.get()));
    public static final RegistryObject<Aspect> LUCRUM = ASPECTS.register("lucrum", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/lucrum.png")).withCompound(AspectInit.HUMANUS.get(), AspectInit.FAMES.get()));
    public static final RegistryObject<Aspect> MACHINA = ASPECTS.register("machina", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/machina.png")).withCompound(AspectInit.FACERE.get(), AspectInit.MOTUS.get()));
    ...
    public static final RegistryObject<Aspect> ITER = ASPECTS.register("iter", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/iter.png")).withCompound(AspectInit.MOTUS.get(), AspectInit.TERRA.get()));
    public static final RegistryObject<Aspect> FRIGUS = ASPECTS.register("frigus", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/frigus.png")).withCompound(AspectInit.AQUA.get(), AspectInit.VITREUS.get()));
    public static final RegistryObject<Aspect> VINCULUM = ASPECTS.register("vinculum", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/vinculum.png")).withCompound(AspectInit.MOTUS.get(), AspectInit.PERDITIO.get()));
    public static final RegistryObject<Aspect> VOLATUS = ASPECTS.register("volatus", () -> new Aspect(List.of(0xCC, 0x59, 0x33), ResourceLocation.parse("thaumaturgy:textures/aspect/volatus.png")).withCompound(AspectInit.MOTUS.get(), AspectInit.AER.get()));
